...
void loop()   /* Runs Continuously */
{
  ...
  joystick[6] = digitalRead(spotlightpin);   // uses the built-in button of the thumb joystick
  joystick[7] = map(analogRead(JOYSTICK_SPEED), 0, 1023, 0, 255);   // Reading Analog 6, sets the speed of the robot
